...
void skolem_0() {
  aeval_tmp_rand_real_1[0] = generateRandomValue(1, 0, USER_val[0], ((double) ((-1))) * (((-10.0)) + ((-USER_val[0]))));
  assert(((USER_val[0]) <= (aeval_tmp_rand_real_1[0])) && ((aeval_tmp_rand_real_1[0]) < (((double) ((-1))) * (((-10.0)) + ((-USER_val[0]))))));

  aeval_tmp_rand_real_0[0] = generateRandomValue(1, 0, ((double) ((-1))) * (((-USER_st[1])) + (((-USER_val[1])) + ((-USER_val[0])))), ((double) ((-1))) * (((-10.0)) + (((-USER_st[1])) + (((-USER_val[1])) + ((-USER_val[0]))))));
  assert(((((double) ((-1))) * (((-USER_st[1])) + (((-USER_val[1])) + ((-USER_val[0]))))) <= (aeval_tmp_rand_real_0[0])) && ((aeval_tmp_rand_real_0[0]) < (((double) ((-1))) * (((-10.0)) + (((-USER_st[1])) + (((-USER_val[1])) + ((-USER_val[0]))))))));

  if (((init == 0) || ((!(init == 0)) && (0.0 == ((USER_st[1]) + (USER_val[1]))))) && ((init == 0) || (historically_0_holds[1]))) {
  historically_0_holds[0] = 1;
  USER_st[0] = 0.0;
  historically_0_signal[0] = 1;
  USER_stx_req[0] = 0.0 == ((init == 0) ? (0.0) : ((USER_st[1]) + (USER_val[1])));
  USER_med_req[0] = (USER_val[0]) == (USER_val[0]);
  USER_median[0] = USER_val[0];
  USER_out_req[0] = ((USER_val[0]) <= (aeval_tmp_rand_real_1[0])) && ((aeval_tmp_rand_real_1[0]) < ((USER_val[0]) + 10.0));
  USER_fuzz[0] = aeval_tmp_rand_real_1[0];
} else {
  historically_0_holds[0] = 1;
  USER_st[0] = (USER_st[1]) + (USER_val[1]);
  historically_0_signal[0] = 1;
  USER_stx_req[0] = ((USER_st[1]) + (USER_val[1])) == ((init == 0) ? (0.0) : ((USER_st[1]) + (USER_val[1])));
  ...
  USER_out_req[0] = ((((USER_st[1]) + (USER_val[1])) + (USER_val[0])) <= (aeval_tmp_rand_real_0[0])) && ((aeval_tmp_rand_real_0[0]) < ((((USER_st[1]) + (USER_val[1])) + (USER_val[0])) + 10.0));
  USER_fuzz[0] = aeval_tmp_rand_real_0[0];
}
