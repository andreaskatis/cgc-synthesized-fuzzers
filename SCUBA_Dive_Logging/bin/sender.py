...
_lib_SCUBA_Dive_Logging = CDLL('../lib/lib_SCUBA_Dive_Logging.so')
_lib_SCUBA_Dive_Logging.step.restype  = c_msg

def cstep(cvg):
    global _lib_SCUBA_Dive_Logging
    return _lib_SCUBA_Dive_Logging.step(cvg)
